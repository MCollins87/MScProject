...
\begin{enumerate}
    ...
    \item Data fragmentation and the case for IDRs;
...
\subsection{Method}
An iterative literature review was adopted, following the guidance outlined by  \cite{dawson2015} (Figure \ref{fig:LitProc}). An initial search was conducted using Google Scholar and open-access repositories (arXiv.org) to identify foundational concepts and terminology related to IDRs, cancer pathways, MDT operations, dashboards, and Design Science Research. These preliminary results informed a more structured search strategy applied to ScienceDirect, IEEEXplore, and PubMed.
...
\begin{figure}
\begin{centering}
    \includegraphics[width=0.75\linewidth]{LitProc.png}
    \caption{Iterative literature review process \citep{dawson2015}}
    \label{fig:LitProc}
\end{centering}
\end{figure}
...
\subsection{Radiotherapy Waiting-Time Recommendations}

In addition to national Cancer Waiting Time standards, radiotherapy services have historically been supported by recommendations published by the Joint Council for Clinical Oncology (JCCO). The JCCO framework recognises that clinically meaningful delay may occur within treatment planning and booking processes that are not always visible within national waiting-time metrics. \cite{ash2004} demonstrated substantial variation in radiotherapy waiting times across the United Kingdom and highlighted the importance of monitoring elapsed time between referral and treatment delivery. 

Unlike national cancer waiting-time standards, which primarily support performance monitoring and accountability, JCCO recommendations provide a clinically focused perspective on the timeliness of radiotherapy delivery. This distinction is important because patients may remain compliant with national targets while still experiencing delays that affect operational performance and service quality. Consequently, both national standards and clinically derived radiotherapy targets have relevance when designing operational analytics for radiotherapy services.
...
Although the reviewed studies demonstrate that delay is clinically important, they generally stop short of explaining how operational teams should detect emerging delays before they become breaches. Consequently, the literature provides strong justification for action but comparatively limited guidance regarding operational intervention.
...
The literature review identifies four principal gaps.
...
Collectively, these gaps suggest that the principal challenge is not the absence of operational data, but the absence of integrated operational intelligence capable of supporting proactive pathway management. The artefact developed in this study was therefore designed to address this specific gap.
