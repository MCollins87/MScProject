...
\subsection{Referral Workload}
 ...
 \begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{DB_Onc.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{DB_RT.png}
...
The significance of this finding should be considered in the context of local service demand. According to National Disease Registration Service (NDRS) benchmarking data, shown in figure \ref{fig:RAD20}, Portsmouth Hospitals University NHS Trust delivered the highest numbers of radiotherapy attendances per linear accelerator in England for the financial year 2024/25 \citep{ndrs2026}. Operating close to planned utilisation thresholds therefore reflects both sustained service demand and high equipment productivity. This reinforces the importance of maintaining sufficient operational flexibility to accommodate urgent treatments and unexpected service pressures.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{RAD20.png}
    \caption{Departmental average number of fractions per linac (RAD20) for financial year 24/25 \citep{ndrs2026}}
    \label{fig:RAD20}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{DB_Overview.png}
...
The dashboard suite was evaluated by three senior operational stakeholders representing different perspectives across the oncology pathway:

\begin{itemize}
    \item Clinical Director for Oncology
    \item Radiotherapy Operations Manager
    \item Lead Treatment Radiographer
\end{itemize}

Full evaluation results are presented in Appendix \ref{appendix:evaluation}.

Participants were provided with a demonstration of the Oncology referral Dashboard, Radiotherapy Service Health Dashboard, and Post-MDT Pathway Dashboard. Evaluation focussed on usability, perceived operational value, and validation of design principles developed in Chapter \ref{method}.

Usability was assessed using the System Usability Scale (SUS). The dashboard suite achieved an average SUS score of 93.3, with individual scores of 95.0, 90.0, and 95.0 respectively. These results indicate a very high perceived usability and suggest that the dashboards were considered intuitive, easy to learn, and straightforward to operate. 

All participants agreed that the dashboard improved visibility of post-MDT pathway performance, helped identify patients approaching target breaches, and reduced reliance on manual reporting processes. Two participants strongly agreed the dashboard would be incorporated into routine operational management activities, while the third agreed with the statement. 

\subsection{Perceived Operational Value}

Stakeholders reported consistently positive perceptions of the operational value of the artefact. All participants strongly agreed that the dashboards improved visibility of pathway performance and supported identification of patients at risk of breaching performance targets. 

The combination of risk monitoring, pathway visibility, and capacity-demand information was considered particularly valuable for supporting operational decision-making. Participants highlighted the potential for the dashboards to reduce reliance on manually generated reports and support more proactive service management. 

The Clinical Director identified the pathway waterfall visualisation and filtering by oncologist and speciality as particularly useful, enabling targeted review of pathway bottlenecks. The Radiotherapy Operations Manager highlighted the ability to investigate patients approaching breaches and support planning decisions relating to capacity, overtime, shift extensions, and additional treatment capacity. The Lead Treatment Radiographer identified the detailed patient worklists as the most useful feature, particularly for day-to-day operational management.
...
Further evaluation was undertaken using structured questions aligned to the six design principles developed in Chapter \ref{method}. 

Support for DP1 was particularly strong, with all participants strongly agreeing that the dashboard helped identify pathway risks before breaches occurred. Similarly, all participants strongly agreed that capacity information was presented in a useful and actionable manner, providing strong support for DP2. 

The pathway stages were considered meaningful representations of operational workflow, supporting DP3. Participants generally agreed that refresh frequency was sufficient for operational use, although one participant indicated that more frequent updates could further support treatment-floor operational activities. This finding provides qualified support for DP4. 

Participants reported high levels of trust in the dashboard metrics, supporting DP5 and demonstrating the importance of provenance and auditability within healthcare analytics environments. 

Finally, all participants agreed that the dashboards aligned well with day-to-day operational activities, supporting DP6 and reinforcing the value of task-oriented dashboard design.
