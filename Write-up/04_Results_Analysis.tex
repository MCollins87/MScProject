...
\begin{figure}
    \includegraphics[width=\linewidth]{DB_Onc.png}
...
Despite relatively short clinic lead times, the average wait experienced by patients already holding future appointments was 38.94 days.

This distinction highlights an important operational observation. The referral-to-clinic metric reflects patients who have already completed the clinic stage, while the booked waiting time reflects future demand against available clinic capacity. The higher booked wait therefore suggests increasing pressure on future appointment capacity rather than a deterioration in historic clinic performance.
...
\begin{figure}
    \includegraphics[width=\linewidth]{DB_RT.png}
...
\begin{figure}
    \includegraphics[width=\linewidth]{DB_Overview.png}
    \caption{Integrated Post-MDT Pathway Dashboard}
    \label{fig:DB_Over}
\end{figure}
\subsection{Pathway Duration}
The integrated pathway dashboard enabled analysis of patient progression from referral through to treatment initiation.

The median pathway duration was 36 days and was composed of five principal operational stages:
...
The largest delay occurred between CT simulation and treatment commencement, accounting for 16 days of the overall pathway.
...
Consequently, further investigation is required before this interval can be interpreted solely as a treatment-capacity issue. Opportunities for future work are discussed in Chapter \ref{future}.
...
\begin{table}[h]
    ...
    \begin{tabular}{|p{7.5cm}|p{7.5cm}|}
        ...
        \hline\hline
        DP1: Surface Breach Risks & RAG categorisation and patient risk work lists \\
...
Analysis of oncology referrals demonstrated relatively efficient referral processing but highlighted growing pressure on future clinic capacity. Radiotherapy analysis identified manageable overall utilisation but a small cohort of higher-risk patients requiring ongoing monitoring.
