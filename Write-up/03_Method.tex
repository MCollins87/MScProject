...
\begin{table}[h]
    ...
    \begin{tabular}{|p{7cm}|p{7cm}|}
        ...
        \hline
        Sharepoint Referral Register & Oncology Referrals \\
        PAS & Clinic Activity \\
        Aria RO & RT workflow \\
        \hline
    \end{tabular}
...
Although the artefact was developed as a research prototype, several software-engineering practices were incorporated to improve reliability and maintainability.reness without visible operational levers does not support 
