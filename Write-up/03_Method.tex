...
Data harmonisation presented a significant challenge due to variation in identifier quality and referral-recording practices. NHS numbers required standardisation across datasets, while oncology referral records frequently contained duplicate records representing the same clinical episode.
