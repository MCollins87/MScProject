...
\begin{enumerate}
    \item identify, quantify, and interpret delays within the MDT-to-treatment pathway;
    \item design and implement an IDR architecture that consolidates and harmonises data from MDT, clinic scheduling, and treatment systems;
    \item develop a decision-support dashboard aligned with ISO 9241-110 usability principles to surface actionable operational insights;
    \item evaluate the artefact's usability, utility, and technical validity through task-based experiments, heuristic analysis, and metric reconciliation;
    \item derive transferable design principles and architecture guidance for NHS oncology operational analytics.
\end{enumerate}
